...
string mgroups_::tofsims_t::to_string(const string del)
{
	stringstream ss;
...
vector<measurements_::sims_t*> mgroups_::tofsims_t::measurements()
{
...
vector<measurements_::sims_t> mgroups_::tofsims_t::measurements_copy()
{
