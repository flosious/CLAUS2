...
filenames::filename_t::filename_t(string& filename_with_path_s, 
...
std::__cxx11::string filenames::filename_t::to_string(const string del)
{
	stringstream ss;
...
bool filenames::filename_t::operator==(filenames::filename_t& obj)
{
