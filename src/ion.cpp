...
/*******    ion_t   ********/
/***************************/
ion_t::ion_t() : logger(__FILE__,"ion_t")
{
}

ion_t::ion_t(std::vector<element_t> elements_s,  quantity::electrical_charge_t electric_charge_s) : elements(elements_s), electric_charge(electric_charge_s), logger(__FILE__,"ion_t")
{
}

ion_t::ion_t(element_t element_s,  quantity::electrical_charge_t electric_charge_s) : elements({element_s}), electric_charge(electric_charge_s), logger(__FILE__,"ion_t")
{
}
