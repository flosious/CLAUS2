...
unordered_set<string> tools::file::filter_files_from_types(unordered_set<string>& file_list, unordered_set<string>& file_types, bool exclude) 
{
    unordered_set<string> included_files, excluded_files;
    bool found=false;
	...
	{ 
		...
		{
            if (file.find(file_type,file.length()-file_type.length())!=string::npos) 
			{
