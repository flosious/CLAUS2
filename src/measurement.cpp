...
bool measurement_t::use_olcdb = true;
bool measurement_t::use_sample = true;
bool measurement_t::use_group = true;
bool measurement_t::use_repition = true;
bool measurement_t::use_settings = true;
