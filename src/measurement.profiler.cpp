...
measurements_::profiler_t::profiler_t(files_::profiler_t&  file, std::__cxx11::list< sample_t >& samples_list, database_t& sql_wrapper) : 
			measurement_t(file.name,file.contents,samples_list,"profiler",sql_wrapper), primary_method_p(file.name.method())
{
